...
//        pluginConfiguration.setConfigurationType("com.xxg.mybatis.plugins.MySQLLimitPlugin");
        ...
        javaModelGeneratorConfiguration.setTargetProject(SystemParameters.DEST_PROJECT_PATH + SystemParameters.JAVA_PATH);
        ...
        sqlMapGeneratorConfiguration.setTargetProject(SystemParameters.DEST_PROJECT_PATH + SystemParameters.RESOURCE_PATH);
        sqlMapGeneratorConfiguration.setTargetPackage("mapper");
        context.setSqlMapGeneratorConfiguration(sqlMapGeneratorConfiguration);

        JavaClientGeneratorConfiguration javaClientGeneratorConfiguration = new JavaClientGeneratorConfiguration();
        javaClientGeneratorConfiguration.setTargetProject(SystemParameters.DEST_PROJECT_PATH + SystemParameters.JAVA_PATH);
