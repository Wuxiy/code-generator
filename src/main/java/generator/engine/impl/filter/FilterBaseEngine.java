    ...
    public void execute() {
        try {
            ...
            for (String filename:fileNames) {
                File file = new File(SystemParameters.DEST_PROJECT_PATH + SystemParameters.JAVA_PATH + TextUtils.packageConvertPath(UserParameters.getPackageName()) + "/"+ SystemParameters.FILTER_PACKAGE_NAME +"/"+filename);
